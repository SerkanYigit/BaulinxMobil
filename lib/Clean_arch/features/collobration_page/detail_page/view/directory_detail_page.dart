...
class DirectoryDetailNeu3 extends StatefulWidget {
  String? folderName;
...
class _DirectoryDetailState extends State<DirectoryDetailNeu3>
                                              ...
                                              Expanded(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Container(
                                                      height:
                                                          75.0, // Set the desired height for your horizontal ListView
                      ...
                      /*    Positioned(
                        ...
                        child: FloatingActionButton(
                          ...
                          onPressed: () async {
                            ...
                            print("fileUploadType" + fileUploadType.toString());
          ...
          children: [
                ...
                () => () async {
                      if (!_controllerFiles.isMoveActionActive) {
                        ...
                        print("_controllerFiles.FileIdList" +
                            _controllerFiles.FileIdList.toString());
            ...
            TopBarButton(
                () => () async {
                      ...
                      List<String> downloadTheseFiles = <String>[];
  ...
  buildGridView() {
    ...
    return GridView.builder(
        ...
        gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
            ...
            crossAxisSpacing: 15,
            mainAxisSpacing: 8),
        itemCount: fileFilter2().length,
        itemBuilder: (BuildContext ctx, index) {
          DirectoryItem item = fileFilter2().elementAt(index);
          ...
          return GestureDetector(
            ...
            onLongPress: () {
              setState(() {
                ...
                print("selectedFileIdList" + selectedFileIdList.toString());
              });
                      ...
                      children: [
                        Stack(
                          children: [
                            ...
                            Row(
                                children: item.labelList != null
                                    ? item.labelList!.map((e) {
                                        print("folderFilter().length : " +
                                            folderFilter2().length.toString());
                                        return Row(
                                          children: [
                                            Positioned(
                                              top: 10,
  ...
  Widget FolderView(DirectoryItem item, index, bool moveActionActive) {
    ...
    return InkWell(
          ...
          if (moveActionActive && !widget.canViewFolders!) {
            ...
            Navigator.push(
                ...
                new MaterialPageRoute(
                    builder: (BuildContext context) => new DirectoryDetailNeu3(
      ...
      child: AnimatedContainer(
        width: Get.width,
        height: 155, //openMenuAnimateValuesFolder[index] ? 125 : 80,
...
//? FOLDERVIEW2
  Widget FolderView2(List<DirectoryItem> item, bool moveActionActive) {
    //print('itemlabelssss' + item.labelList.toString());
    var dateFormatter =
        new DateFormat.yMMMMd(AppLocalizations.of(context)!.localeName);
    return ExpandableTileView.animatedDef(
        title: "Main Directory", child: expandableText(item));
  ...
  Widget expandableText(List<DirectoryItem> item) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        Padding(
                    ...
                    children: <Widget>[
                      SearchableDropdown.multiple(
                        ...
                        onChanged: (value) {
                          ...
                          print(" LAbelId" +
                              selectedLabelAndFiles.labelIds!.first.labelId
                                  .toString());
                        },
