...
class ControllerInvoice extends GetxController implements InvoiceBase {
  ...
  Future<GetInvoiceListResult> GetInvoiceList(Map<String, String> header,
    ...
    var value = await _filesService.GetInvoiceList(header,
        userId: userId!,
        year: year!,
        month: month!,
  ...
  Future<bool> InvoiceFileInsert(Map<String, String> header,
    ...
    var value = await _filesService.InvoiceFileInsert(header,
        Id: Id!,
        FileId: FileId!,
...
//Todo
    ...
    if (true) { return response.data!["Result"][0]["Id"];
  ...
  Future<DataLayoutAPI> InvoiceMultiUpdate(Map<String, String> header,
    ...
    DataLayoutAPI result = await _filesService.InvoiceMultiUpdate(header,
        UserId: UserId!, InvoiceList: InvoiceList!,);
  ...
  Future ConfirmPeriod(Map<String, String> header,
    ...
    await _filesService.ConfirmPeriod(header,
        UserId: UserId!,
        CustomerId: CustomerId!,
        Year: Year!,
        Month: Month!,
  ...
  Future OpenPeriod(Map<String, String> header,
      ...
      int? Month,
      bool? IsFileTransfer}) async {
    await _filesService.OpenPeriod(header,
        UserId: UserId!,
        CustomerId: CustomerId!,
        Year: Year!,
        Month: Month!,
  ...
  Future<GetInvoiceListResult> GetInvoiceListWithOutFile(
      ...
      double? WithOutTaxValue,
      int? FileType,}) async {
    var value = await _filesService.GetInvoiceListWithOutFile(header,
        userId: userId!,
        year: year!,
        month: month!,
        invoiceBlock: invoiceBlock!,
  ...
  Future<GetAllOfferResult> GetAllOffer(Map<String, String> header,
    ...
    return await _filesService.GetAllOffer(header,
        UserId: UserId!,
        CreatedForUserId: CreatedForUserId!,
        MyCustomer: MyCustomer!,);
  }
