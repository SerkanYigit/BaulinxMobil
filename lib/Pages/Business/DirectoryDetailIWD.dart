                          ...
                          child: FloatingActionButton(
                            ...
                            onPressed: () async {
                              ...
                              if (fileUploadType == 0) {
                                ...
                                bool imageFlag = true;
                                for (int i = 0; result!.names.length > i; i++) {
                                  String fileName =
                                ...
                                if (imageFlag) {
                                  ...
                                  fileBytes = File(result.files.single.path!)
                                      .readAsBytesSync();
                                  fileContent = base64.encode(fileBytes);
                                }
                              ...
                              await uploadInvoiceFile(files,
                                  ...
                                  MyCustomer: _controllerInvoice.MyCustomer!,
                                  CreatedForUserId:
                                      _controllerInvoice.CreatedForUserId!,
                                  InvoiceName: _controllerInvoice.InvoiceName!,
                                  InvoiceNumber:
