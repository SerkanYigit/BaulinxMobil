...
class ChatDetailPageForTablet extends StatefulWidget {
  final int Id;
  final String image;
  ...
  @override
  _ChatDetailPageForTabletState createState() =>
      _ChatDetailPageForTabletState();
}
...
class _ChatDetailPageForTabletState extends State<ChatDetailPageForTablet>
...
//Controller for animation
  ...
  @override
  void didUpdateWidget(ChatDetailPageForTablet oldWidget) {
  ...
  void _initialize() {
    ...
    widget.directLink ? joinMeeting() : null;
  ...
  void openMeeting() async {
    await Permission.camera.request();
    await Permission.microphone.request();
    setState(() {
      _panelMinSize = Get.height * 0.75;
                            ...
                            Expanded(
                              child: Container(
                                ...
                                margin: EdgeInsets.only(
                                    bottom: WidgetsBinding.instance.window
                                                .viewInsets.bottom >
                                            0
                                        ? 10
                                        : Get.height > 1000
                                                      ...
                                                      i != 0
                                                          ? (DateTime.parse(_getChatResult
                                                                  ...
                                                                  DateTime.parse(_getChatResult
                                                                      ...
                                                                      .day)
                                                              ? TimeMessage(
                                                                  message: DateFormat.yMMMd().format(DateTime.parse(_getChatResult
                                                                              .result!
                                                                              .messages![
                                                                                  i]
                                                                              .createDate!)) ==
  ...
  Widget Header(double padding, GetChatResult getChatResult, String image) {
    return Container(
      width: Get.width / 2,
      height: Get.height > 800 ? 70 : Get.height / 10,
                      ...
                      child: Container(
                          ...
                          child: CachedNetworkImage(
                              ...
                              placeholder: (context, url) => new Text(
                                  "ChatDetailPage") //CustomLoadingCircle(),
                              )),
                    ),
                    Positioned(
                      bottom: 5,
