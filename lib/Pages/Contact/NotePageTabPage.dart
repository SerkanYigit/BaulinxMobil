...
class NotePageTabPage extends StatefulWidget {
  final int? CustomerId;
  final int? moduleType;
  const NotePageTabPage({Key? key, this.CustomerId, this.moduleType})
      : super(key: key);

  @override
  _NotePageTabPageState createState() => _NotePageTabPageState();
}

class _NotePageTabPageState extends State<NotePageTabPage>
  ...
  Future<void> GetNote({String search = ""}) async {
    _todosResult = await _controllerTodo.GetGenericCustomerTodos(
        _controllerDB.headers(),
        userId: _controllerDB.user.value!.result!.id,
  ...
  Future<void> UpdateNotes(int TodoId,
    ...
    await _controllerTodo.UpdateCommonTodos(
      ...
      setState(() {
        ...
        print("value data" + value.genericTodoUpdate!.backgroundImage!);
    ...
    return GetBuilder(
      builder: (ControllerTodo controller) {
        ...
        return Scaffold(
          ...
          body: isLoading
              ? Text("notepage") //CustomLoadingCircle()
                                  ...
                                  children: [
                                    ...
                                    AnimatedContainer(
                                      ...
                                      child: SearchableDropdown.multiple(
                                            ...
                                            for (int i = 0;
                                                i <
                                                    selectedLabelIndexesForSearch
                                                        .length;
                                                i++) {
                                              selectedLabelForSearch.add(labelsList[
                                                      selectedLabelIndexesForSearch[
                                                          i]]
                                                  .id!);
                                            }
                                        ...
                                        closeButton: null,
                                        style: Get.theme.inputDecorationTheme
                                            .hintStyle,
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    CircleAvatar(
                                                                      radius:
                                                                          15,
                                                                      backgroundImage: NetworkImage(_todosResult
                                                                          .genericTodo![
                                                                              index]
                                                                          .ownerPicture!),
                                                                    ),
                                                                    ...
                                                                    Text(_todosResult
                                                                        ...
                                                                        .ownerName!),
                                                                    Spacer(),
                                                                    Text(DateFormat.yMMMd(AppLocalizations.of(context)!.date).format(DateTime.parse(_todosResult
                                                                        .genericTodo![
                                                                            index]
                                                                        .createDate!)))
                                                                  ],
        ...
        children: [
          GestureDetector(
              ...
              child: Icon(
                ...
                color: listOfGenericTodo.remindDate!.isNullOrBlank!
                    ? Colors.black
                    : Colors.green,
              )),
          SizedBox(
