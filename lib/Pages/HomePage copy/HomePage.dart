            ...
            body: Stack(children: [
              Padding(
                ...
                child: Container(
                  ...
                  children: [
                    //? Profil resmi ve butonlar
                    _customAvatar(context),
/* 
                    ...
                    Column(
                      children: [
                        Align(
                          ...
                          child: Text(
                            'Effizienz planen, Qualität bauen,\nZukunft sichern',
                            style: TextStyle(
                              fontSize: 20,
                    ...
                    */
                    ...
                    //! SizedBox(height: 15),
                    // !isTablet ? _searchWidget(context) : SizedBox(),
                    //if (isTablet)
                    //? Proje ve takım widgeti
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Container(
                        height: Get.height / 7,
                          ...
                          isPrivate
                              ? SizedBox(
                                  child: Container(
                                    width: 1,
                                    color:
                                        const Color.fromARGB(255, 62, 18, 222),
                                  ),
                                )
                              : Expanded(
                                  //flex: 2,
