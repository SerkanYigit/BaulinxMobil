...
//import 'package:undede/Pages/HomePage/ilcelist_class.dart';
...
*/
  ...
  bool panelType = true;
  String MeetingUrl = "";
//https://api.baulinx.de/api/chat/GetUserList?request.userId=2715
  ...
  ListView listViewProject() {
    ...
    return ListView.builder(
      ...
      itemCount: _commonGroup.length, // 27
      itemBuilder: (context, index) {
        selectedCommonGroupId = _commonGroup[index].id;
        print(selectedCommonGroupId);
        getAllCommans();

        publicCommonBoardList = _commons.result!.commonBoardList!;
          ...
          onTap: () {
            ...
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => HomePage2(
                      commonBoardListItem: publicCommonBoardList,
                      commonGroupSelected: _commonGroup[index],
                    )));
          },
          child: DashCard(
            commonBoardListItem: publicCommonBoardList,
            commonGroupSelected: _commonGroup[index],
            title: _commonGroup[index].groupName!,
            userImage:
                'https://img.freepik.com/free-vector/smiling-redhaired-boy-illustration_1308-176664.jpg?t=st=1738863165~exp=1738866765~hmac=4edda2637afeeb8700348a491dab74195219452c13922c942a49afe2830ce8e6&w=1060',
            backgroundColor: Colors.white,
              ...
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => InvoiceWithDocumentPage(
                    invoiceWithDocumentType: InvoiceWithDocumentType.IncomePaid,
                  ),
                ),
              );
            },
            ikon: Icons.euro,
            kolorIkon: Colors.blue,
            kolorCevre: Colors.blue[100],
          ),
          //? Ariza Takip
          DocumentButton(
            ikon: Icons.note_alt_outlined,
            kolorIkon: Colors.yellow,
            kolorCevre: Colors.yellow[100],
          ),
          //? Document Analyz
          DocumentButton(
            onTap: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => DocumentAnalysis(),
                ),
              );
            },
            ikon: Icons.analytics_outlined,
            kolorIkon: Colors.green,
            kolorCevre: Colors.green[100],
          ),
          //? Ocr
          DocumentButton(
            onTap: () {
            ...
            kolorIkon: Colors.purple,
            kolorCevre: Colors.purple[100],
          ),
        ],
      ),
    );
  ...
  CarouselSlider caruzel(Orientation orientation) {
    return CarouselSlider.builder(
      itemBuilder: (ctx, index, xx) //! xx degeri eklendi
        ...
        /*    _commons.result!.commonBoardList!.isEmpty
            ? Container(
            ...
            Expanded(
              ...
              child:
                ...
                decoratorProps: DropDownDecoratorProps(
                  ...
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                      ...
                      borderSide:
                          BorderSide(color: Colors.grey), // Kenarlık rengi
                    ),
                  ),
                ),
                ...
                popupProps: PopupProps.menu(
                  menuProps: MenuProps(
                      backgroundColor:
                          const Color.fromARGB(255, 233, 231, 224)),
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Row(
                                children: [
                                  ...
                                  SizedBox(
                                      width: 10), // Add spacing between chips
                                ],
                              );
                            },
                          ),
  ...
  Container _customAvatar(BuildContext context) {
    ...
    return Container(
      ...
      padding: EdgeInsets.only(
        ...
        bottom: 10,
        top: 10,
        // only( top: MediaQuery.of(context).padding.top,
      ),
      child: Container(
        child: Column(
          children: [
...
class DocumentButton extends StatelessWidget {
  ...
  DocumentButton({this.ikon, this.kolorCevre, this.kolorIkon, this.onTap});
  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: onTap,
...
class DocumentUserPhoto extends StatelessWidget {
  IconData? ikon;
  Color? kolorIkon;
  Color? kolorCevre;
  GestureTapCallback? onTap;
  ...
  DocumentUserPhoto(
      {this.ikon, this.kolorCevre, this.kolorIkon, this.onTap, this.urlPhoto});
  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: onTap,
...
class CardWidgetHomePage extends StatelessWidget {
