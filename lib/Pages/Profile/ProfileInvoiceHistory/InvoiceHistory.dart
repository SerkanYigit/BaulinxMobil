...
//! foreach yerine for kullanildi
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(_invoiceHistoryResult.historyResult!.length == null
                            ? "0"
      ...
      body: isLoading
          ...
          : Column(
              ...
              children: [
                ...
                Expanded(
                    child:
                        isListView ? buildListviewMode() : buildPreviewMode()),
  ...
  Widget FileViewInListView(HistoryResult item, int index) {
    ...
    return GestureDetector(
      onTap: () {
        Get.to(() => PDFviewChat(
              file: File(item.file!.path!), //! File icerisine alindi. InvoiceFile olara degistirildi
