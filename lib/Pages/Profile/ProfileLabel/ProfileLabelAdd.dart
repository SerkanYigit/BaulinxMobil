...
class ProfileLabelAdd extends StatefulWidget {
  const ProfileLabelAdd({Key? key}) : super(key: key);

  @override
  _ProfileLabelAddState createState() => _ProfileLabelAddState();
}

class _ProfileLabelAddState extends State<ProfileLabelAdd> {
  ...
  void timecolor() {
    ...
    _colorCollection.add(const Color(0xFFece8e8));
